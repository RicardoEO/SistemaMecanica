        ...
        <script type="text/javascript">
         ...
         <nav class="menu">
            ...
            <div class="gestionar">
                ...
                <div class="item" id="actual" onclick="location.href='./gest_alumnos.php'"><img src="../../img/estudiante.png"><a href="./gest_alumnos.php">Alumnos</a></div>
            ...
            <main class="contenedor2" style="display: none;">
             <section class="registro">   
                    ...
                    <header class="titulo_reg"><h2>Gestionar alumnos</h2></header>
