...
/*                     $verificacion = "SELECT * from alumno_curso where rutalumno = '$rut' and idcurso = '$select';";
                    ...
                    $exito2 = 0;
                        ...
                        if ($contar == 0) {
                            ...
                            $verificacion2 = "SELECT * from usuario where rut_usuario = '$rut'";
                            $pre_rs2 = mysqli_query($link, $verificacion2);
                            $contar2 = mysqli_num_rows($pre_rs2);
                            ...
                            $GLOBALS['estado'] = "exito";
  
                            }

                        } else {
                       
                            $verificacion4 = "SELECT * from alumno_curso where rutalumno = '$rut' and idcurso = '$select';";
                            $exito++;
                            $pre_rs4 = mysqli_query($link, $verificacion4);

                            $contar4 = mysqli_num_rows($pre_rs4); 
                ...
                if($GLOBALS['estado']=="exito") {
                    echo "Operacion exitosa";
                } else {
                    if($GLOBALS['estado']=="error") {
                        echo "Error";
                    } else {
                        echo "Error";
                    }
