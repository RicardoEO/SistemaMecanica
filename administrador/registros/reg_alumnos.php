...
if ($contar == 0) {
	...
	$consulta = "INSERT into alumno (rutalumno, nombres, correoalumno, appaterno, apmaterno, telefonoalumno) values ('$rut', '$nom_alumno', '$correo', '$ap_p_alumno', '$ap_m_alumno', '$telefono')";
