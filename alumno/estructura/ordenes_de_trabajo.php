                    ...
                    <form method="post" class="formulario">
                        ...
                        <table id="tabla" class="tabla">
                            ...
                            <?php 
                                ...
                                $rut = $_SESSION['rut'];
                                $consulta = "SELECT ID_GRUPO from alumno_grupodetrabajo WHERE RUTALUMNO = $rut";

                                $resultset0 = mysqli_query($link, $consulta) or die ("Error en la consulta2");
                                while($fila0=mysqli_fetch_array($resultset0)) {

                                    $consulta2 = "SELECT * from ordendetrabajo where gru_id_grupo = $fila0[ID_GRUPO]";
                                    ...
                                    while($fila=mysqli_fetch_array($resultset)) {
                                        ...
                                        echo "<td> <img class='editar' name= '" .$fila[3]. "' src='../../img/edit.png' id='" .$fila[0]. "' onClick='editar(this);' alt='Editar'/>
